...
# Pure Asyncio Health Check Server (Render-এর জন্য)
...
async def main():
    # হেলথ চেক সার্ভার চালু
    await start_health_server()
    
    # টেলিগ্রাম বট ক্লায়েন্ট চালু (একই ইভেন্ট লুপে)
